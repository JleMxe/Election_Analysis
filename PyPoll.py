...
candidate_options = []
# Declare a dictionary to contain candidates and votes
candidate_votes = {}
...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        # Check to see if candidate is in candidate_options list
...
with open(file_to_save, "w") as txt_file:
    # Print the final cote count to the terminal.
    election_results = (
        f"\nElection Results\n"
        f"-------------------------\n"
    ...
    for candidate_name in candidate_votes:
        ...
        # Calcuclate the percentage of votes.
        ...
        if (votes > winning_count) and (vote_percentage > winning_percentage):
            # If tru then set winning_count = votes and winning_percent = vote_percentage
            winning_count = votes
